...
public class RangeScanTargetResolver implements ScanTargetResolver {
    ...
    public RangeScanTargetResolver(String fromIpv4, String toIpv4, int portStart, int portEnd) {
    ...
    public RangeScanTargetResolver(String ipv4, int prefix, int portStart, int portEnd) {
